...
class HomeView extends Component {
  ...
  render() {
    ...
    const handleShow = (e) => {
      ...
      this.setState({show : true, currHotel : e.target.parentElement.children[0].textContent})
    };
          ...
          >
            ...
            <div className="col-md-3 hotel-item">
              <Link to="/" className="text-decoration-none hotel-col">
                ...
                <div className="text-left hotel-text"><p className="hotel-name">Uptown 501</p><p className="hotel-rating">5.4 &#9733;</p></div>
                <div className="h6 hotel-add">Cidco</div>
